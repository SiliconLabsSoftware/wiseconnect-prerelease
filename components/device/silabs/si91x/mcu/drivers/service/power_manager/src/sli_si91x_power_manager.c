...
#define PMU_GOOD_TIME            20         // 900us PMU good time duration
#define XTAL_GOOD_TIME           0          // XTAL good duration count
#define XTAL_GOOD_TIME_PS0       25         // XTAL good duration count for without retention
...
#endif
  // Configure XTAL Start-up Time to be used on Wake-up
  RSI_PS_XtalGoodTimeDurationConfig(XTAL_GOOD_TIME_PS0);
