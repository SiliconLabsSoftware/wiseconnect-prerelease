...
>**Note:**
> Concurrent Paho MQTT client connections over WebSocket are **not** supported in the current Silabs port (a single shared WebSocket handle is used). Use one active WebSocket MQTT client at a time.
