...
- **SoC Mode**:
  - Standalone
    ...
    > **Note:** Two BRD4002B mainboards are required—one to attach the BRD4338A and another for the EFR32xG24. To connect both BRD4002B boards, an EFM32/EFR32 GPIO Header board is needed.
