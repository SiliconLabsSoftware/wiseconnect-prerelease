...
> **Note**:
>
> - To monitor incoming data during debugging sessions, add the `data_in` buffer to your watch window. This allows you to inspect received data in real-time while stepping through the code.
