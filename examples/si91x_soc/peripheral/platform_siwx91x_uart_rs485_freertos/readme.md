# Platform SiWx91x UART RS485 FreeRTOS

## Table of Contents

- [Platform SiWx91x UART RS485 FreeRTOS](#platform-siwx91x-uart-rs485-freertos)
...
- Open **platform_siwx91x_uart_rs485_freertos.slcp**, select the **Software Component** tab, and search for **UART**, **USART**, or **RS485** to adjust instances and UC-backed settings.
- This example targets **three** Studio projects (one master, two slaves). Edit `uart_rs485_mode_freertos.c` in `examples/si91x_soc/peripheral/platform_siwx91x_uart_rs485_freertos/` per role:
