# Platform SiWx91x Simple Button FreeRTOS

## Table of Contents

- [Platform SiWx91x Simple Button FreeRTOS](#platform-siwx91x-simple-button-freertos)
...
- Open **platform_siwx91x_simple_button_freertos.slcp** project file, select the **Software Component** tab, and search for **BUTTON** in the search bar.
