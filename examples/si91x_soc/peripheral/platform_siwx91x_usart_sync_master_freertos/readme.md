# Platform SiWx91x USART SYNCHRONOUS MASTER - FreeRTOS

## Table of Contents

- [Platform SiWx91x USART SYNCHRONOUS MASTER - FreeRTOS](#platform-siwx91x-usart-synchronous-master---freertos)
...
- Open the **platform_siwx91x_usart_sync_master_freertos.slcp** project file, select the **Software Component** tab, and search for **USART** in the search bar.
...
1. Open `platform_siwx91x_usart_sync_master_freertos.slcp` → Software Components → USART.
...
1. Wire clock, TX, and RX between the two boards as listed in the pin tables:
   ...
   - GND ↔ GND
2. Flash `platform_siwx91x_usart_sync_slave_freertos` on the slave board **first** and reset it.
