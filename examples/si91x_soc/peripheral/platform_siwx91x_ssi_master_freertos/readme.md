# Platform SiWx91x SSI MASTER FreeRTOS

## Table of Contents

- [Platform SiWx91x SSI MASTER FreeRTOS](#platform-siwx91x-ssi-master-freertos)
...
- Open the **platform_siwx91x_ssi_master_freertos.slcp** project file, select the **Software Component** tab, and search for **SSI** in the search bar.
