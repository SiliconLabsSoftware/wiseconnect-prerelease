...
- Configure the following macros in [`ssi_master_freertos.c`](https://github.com/SiliconLabs/wiseconnect/blob/v4.0.1-content-for-docs/examples/si91x_soc/peripheral/platform_siwx91x_ssi_master_freertos/ssi_master_freertos.c) if required:
