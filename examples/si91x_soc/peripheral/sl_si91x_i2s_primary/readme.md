...
2. On one board, build and run the I2S secondary application from the WiseConnect repository: [i2s secondary](https://github.com/SiliconLabs/wiseconnect/tree/v4.1.2-content-for-docs/examples/si91x_soc/peripheral/sl_si91x_i2s_secondary).
