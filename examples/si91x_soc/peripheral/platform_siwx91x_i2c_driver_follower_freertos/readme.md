# Platform SiWx91x I2C DRIVER FOLLOWER FreeRTOS

## Table of Contents

- [Platform SiWx91x I2C DRIVER FOLLOWER FreeRTOS](#platform-siwx91x-i2c-driver-follower-freertos)
...
- Open the `platform_siwx91x_i2c_driver_follower_freertos.slcp` project file, select the **Software Component** tab, and search for **i2c** in the search bar.
...
- After completing the above UC configurations, configure the following macros in `i2c_follower_freertos.c` if required:
  ...
  ```c
  #define OWN_I2C_ADDR     0x50  // Update I2C own address
