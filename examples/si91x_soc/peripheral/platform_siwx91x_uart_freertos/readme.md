# Platform SiWx91x UART FreeRTOS

## Table of Contents

- [Platform SiWx91x UART FreeRTOS](#platform-siwx91x-uart-freertos)
...
- Open the `platform_siwx91x_uart_freertos.slcp` project file, select the **Software Component** tab, and search for **UART** in the search bar.
