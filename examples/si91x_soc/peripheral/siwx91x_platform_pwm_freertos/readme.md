...
- Configure the following macros in the [`pwm_mode_freertos.c`](https://github.com/SiliconLabs/wiseconnect/blob/v4.0.1-content-for-docs/examples/si91x_soc/peripheral/platform_siwx91x_pwm_freertos/pwm_mode_freertos.c) file and update/modify following macros, if required.
