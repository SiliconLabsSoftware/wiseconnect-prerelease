...
- Configure timer using following macros, defined in [**sl_si91x_ulp_timer_inst_config.h**](../../../../components/device/silabs/si91x/mcu/drivers/unified_api/config/sl_si91x_ulp_timer_inst_config.h) file and update/modify following macros if required:
