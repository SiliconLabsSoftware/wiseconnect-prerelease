# Platform SiWx91x USART Asynchronous FreeRTOS

## Table of Contents

- [Platform SiWx91x USART Asynchronous FreeRTOS](#platform-siwx91x-usart-asynchronous-freertos)
...
- Open the `platform_siwx91x_usart_async_freertos.slcp` project file, select the **Software Component** tab, and search for **USART** in the search bar.
