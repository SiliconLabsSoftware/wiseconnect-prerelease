# Platform SiWx91x ADC FIFO Mode FreeRTOS

## Table of Contents

- [Platform SiWx91x ADC FIFO Mode FreeRTOS](#platform-siwx91x-adc-fifo-mode-freertos)
...
- Open **platform_siwx91x_adc_fifo_mode_freertos.slcp** project file, select **Software Component** tab, and search for **ADC** in the search bar.
