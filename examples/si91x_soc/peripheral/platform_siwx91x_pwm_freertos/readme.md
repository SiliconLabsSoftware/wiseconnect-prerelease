# Platform SiWx91x PWM FreeRTOS

## Table of Contents

- [Platform SiWx91x PWM FreeRTOS](#platform-siwx91x-pwm-freertos)
...
- Configure the following macros in the `pwm_mode_freertos.c` file and update/modify following macros, if required.
...
- Open the **platform_siwx91x_pwm_freertos.slcp** project file, select the **Software Component** tab, and search for **PWM** in the search bar.
