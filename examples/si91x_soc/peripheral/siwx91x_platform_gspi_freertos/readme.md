...
- Configure the following macros in [`gspi_freertos.c`](https://github.com/SiliconLabs/wiseconnect/blob/v4.0.1-content-for-docs/examples/si91x_soc/peripheral/siwx91x_platform_gspi_freertos/gspi_freertos.c) if required:
