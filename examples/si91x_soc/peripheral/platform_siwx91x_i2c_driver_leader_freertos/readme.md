# Platform SiWx91x I2C DRIVER LEADER FreeRTOS

## Table of Contents

- [Platform SiWx91x I2C DRIVER LEADER FreeRTOS](#platform-siwx91x-i2c-driver-leader-freertos)
...
- Open the `platform_siwx91x_i2c_driver_leader_freertos.slcp` project file, select the **Software Component** tab, and search for **i2c** in the search bar.
...
- After completing the above UC configurations, configure the following macros in `i2c_leader_freertos.c` if required:
  ...
  ```c
  #define FOLLOWER_I2C_ADDR  0x50  // Update I2C follower address
