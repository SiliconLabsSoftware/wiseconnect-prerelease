...
- Configure the following macros in [`usart_sync_slave_freertos.c`](https://github.com/SiliconLabs/wiseconnect/blob/v4.0.1-content-for-docs/examples/si91x_soc/peripheral/platform_siwx91x_usart_sync_slave_freertos/usart_sync_slave_freertos.c) if required:
