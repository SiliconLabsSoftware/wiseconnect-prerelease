# Platform SiWx91x SSI SLAVE FreeRTOS

## Table of Contents

- [Platform SiWx91x SSI SLAVE FreeRTOS](#platform-siwx91x-ssi-slave-freertos)
...
- Open the **platform_siwx91x_ssi_slave_freertos.slcp** project file, select the **Software Component** tab, and search for **SSI** in the search bar.
...
>
> Configure the following macro in the `ssi_slave_freertos.c` file to set the SSI baud rate for the slave:
>
> ```C
