# Platform SiWx91x GSPI FreeRTOS

## Table of Contents

- [Platform SiWx91x GSPI FreeRTOS](#platform-siwx91x-gspi-freertos)
...
- Open the **platform_siwx91x_gspi_freertos.slcp** project file, select the **Software Component** tab, and search for **GSPI** in the search bar.
...
- Configure the following macros in the [`gspi_freertos.h`](https://github.com/SiliconLabs/wiseconnect/blob/v4.0.0-content-for-docs/examples/si91x_soc/peripheral/platform_siwx91x_gspi_freertos/gspi_freertos.h) file and update/modify following macros, if required.
