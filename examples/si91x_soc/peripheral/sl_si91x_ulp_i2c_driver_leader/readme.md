...
- After above UC configurations also configure following macros in [`ulp_i2c_leader_example.c`](https://github.com/SiliconLabs/wiseconnect/blob/v4.1.0-content-for-docs/examples/si91x_soc/peripheral/sl_si91x_ulp_i2c_driver_leader/ulp_i2c_leader_example.c) file and update/modify following macros if required.
