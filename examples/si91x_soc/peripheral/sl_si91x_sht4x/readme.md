...
- Configure the following macros in [`sht4x_example.c`](https://github.com/SiliconLabs/wiseconnect/blob/v4.0.1-content-for-docs/examples/si91x_soc/peripheral/sl_si91x_sht4x/sht4x_example.c) file and update/modify following macros, if required.
