# Platform SiWx91x ADC Static Mode FreeRTOS

## Table of Contents

- [Platform SiWx91x ADC Static Mode FreeRTOS](#platform-siwx91x-adc-static-mode-freertos)
...
- Open **platform_siwx91x_adc_static_mode_freertos.slcp** project file, select **Software Component** tab, and search for **ADC** in search bar.
