 ...
 * To wrap the input key and use it, set WRAP_INPUT_KEYS macro to 1 in [`psa_gcm_app.c`](https://github.com/SiliconLabs/wiseconnect/blob/v4.1.0-content-for-docs/examples/si91x_soc/crypto/si91x_psa_gcm/psa_gcm_app.c)
 * To use a wrapped key directly, set IMPORT_WRAPPED_KEYS macro to 1 in [`psa_gcm_app.c`](https://github.com/SiliconLabs/wiseconnect/blob/v4.1.0-content-for-docs/examples/si91x_soc/crypto/si91x_psa_gcm/psa_gcm_app.c)
