...
> **Recommended Settings:** For optimal configuration, please refer the [recommendations guide](https://docs.silabs.com/wiseconnect/latest/wiseconnect-developers-guide-prog-recommended-settings/).
...
- After the application has been successfully flashed, Wi-Fi commander tool would recieve `sl_wifi_evt_system_boot` event indicating module is ready and tool can now send commands and receive the corresponding responses and events.
...
- Open the Wi-Fi Commander Tool from Simplicity Studio.
- Navigate to the API Reference tab.
